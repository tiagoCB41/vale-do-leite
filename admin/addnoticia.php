                    ...
                    <div class="flex flex-wrap">
                      ...
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?php echo $subtitulo; ?>" name="subtitulo" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Subtitulo da noticia" />
                        </div>
                      </div>
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                      ...
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?php echo $link; ?>" name="link" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Link de redirecionamento da noticia" />
                        </div>
                      </div>
                      ...
                      <div class="w-full lg:w-12/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value="<?php echo $texto_1; ?>" name="texto_1" type="text" id="default" placeholder="Texto da noticia"></input>
                        </div>
                      </div>
                      ...
                      <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?php echo $descricao; ?>" name="descricao" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Descrição da noticia" />
                        </div>
                      </div>
                      <div class="w-full lg:w-6/12 px-4">
